...
<html>
    ...
    <body>
                    ...
                    <c:forEach var="F" items="${listFoodHomePage}">
                        <div class="col-md-3">
                            <div class="product-top">
                                ...
                                <c:choose>
                                    <c:when test="${ empty isMember && not empty isAdmin }">
        ...
        <div class="pagination">
            <c:forEach var="s" begin="1" end="${end}">
                <a href="ShoppingManager?btAction=Search&&index=${s}&&txtSearch=${txtSearch}&&categoryFood=${saveCategory}&&fromPrice=${from}&&toPrice=${to}">${s}</a>
            </c:forEach>
        </div>
