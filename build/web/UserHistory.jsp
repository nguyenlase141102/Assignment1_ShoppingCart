                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            ...
                            <c:choose>
                                <c:when test="${not empty isAdmin }">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="DeleteRecord.jsp"><i class="fa fa-user" aria-hidden="true"></i> Manage Deleted Food</a>
                                    <li class="nav-item">
                                        <a class="nav-link" href="AddFood.jsp"><i style="font-size:20px" class="fa">&#xf067;</i> Add Food</a>
                                    </c:when>
                                </c:choose>   
                                ...
                                <c:choose>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="ShoppingCart.jsp"><i class="fa fa-shopping-cart"></i> Cart</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link" href="UserHistory.jsp"><i class="fa fa-history"></i>Shopping History</a>
                                    </li>
                        ...
                        <form class="form-inline my-2 my-lg-0" action="ShoppingManager">
                            ...
                            <input class="form-control mr-sm-2" type="text" placeholder="Input date"  name="dateSearch">
                            
                            <br>
                            &nbsp;
                            <input class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search" name="txtSearch">
                            <input class="btn btn-outline-success my-2 my-sm-0" type="submit" name="btAction" value="search Food"/>
                        </form>
                ...
                <c:choose>
                    <c:when test="${empty historySearch}">
                        <table class="table table-striped table-dark">
                            ...
                            <tbody>
                                <c:forEach var="s" items="${listUserHistory}" varStatus="counter">
                                    <tr>
                                        <td>${counter.count}</td>
                                        <td>${s.nameUserHistory}</td>
                                        <td>${s.quantityUserHistory}</td>
                                        <td>${s.priceUserHistory}</td>
                                        <td>${s.dateUserHistory}</td>
                                    </tr>
                                </c:forEach>
